...
var k = R((exports, module) => {
  ...
  exports.keys = keys;
  function values(t) {
    for (var e = [], r = Object.keys(t), n = 0; n < r.length; n++) e.push(t[r[n]]);
    return e;
  }
  ...
  function forEach(t, e) {
    if (Array.isArray(t)) for (var r = 0; r < t.length; r++) e.call(null, t[r], r);
    else if (isObject(t))
  ...
  function reduce(t, e, r) {
    for (
      var n = Array.isArray(t), i = n ? t : values(t), a = n ? [] : keys(t), o = r, s = 0;
      s < i.length;
      s++
    )
    ...
    (t.prototype.saveState = function () {
      ...
      (t.prototype.quantifier = function (u) {
          ...
          case '{':
            ...
            switch (this.popChar()) {
              ...
              case ',':
                var g;
                this.isDigit()
                  ? ((g = this.integerIncludingZero()), (d = { atLeast: _, atMost: g }))
        ...
        if (!(u === !0 && d === void 0))
          return (
            s(d),
            this.peekChar(0) === '?' ? (this.consumeChar('?'), (d.greedy = !1)) : (d.greedy = !0),
            (d.type = 'Quantifier'),
            (d.loc = this.loc(A)),
            d
          );
      ...
      (t.prototype.atom = function () {
        ...
        return (
          u === void 0 && this.isPatternCharacter() && (u = this.patternCharacter()),
          s(u),
          (u.loc = this.loc(d)),
...
`:
      ...
      (t.prototype.characterClass = function () {
        var u = [],
          d = !1;
        for (
          this.consumeChar('['), this.peekChar(0) === '^' && (this.consumeChar('^'), (d = !0));
          this.isClassAtom();
...
`:
      ...
      (t.prototype.consumeChar = function (u) {
        if (u !== void 0 && this.input[this.idx] !== u)
          throw Error(
            "Expected: '" + u + "' but found: '" + this.input[this.idx] + "' at offset: " + this.idx
          );
            ...
            case 'Set':
              ...
              pe.forEach(o.value, function (f) {
                if (typeof f == 'number') bt(f, e, r);
                  ...
                  var p = f;
                  if (r === !0) for (var l = p.from; l <= p.to; l++) bt(l, e, r);
                  else {
                    for (var l = p.from; l <= p.to && l < Ce.minOptimizationVal; l++) bt(l, e, r);
                    if (p.to >= Ce.minOptimizationVal)
                      for (
                        var m = p.from >= Ce.minOptimizationVal ? p.from : Ce.minOptimizationVal,
                          v = p.to,
    ...
    r('Transform Patterns', function () {
      (i = !1),
        (a = h.map(n, function (g) {
          ...
          if (h.isRegExp(y)) {
            var b = y.source;
            return b.length === 1 && b !== '^' && b !== '$' && b !== '.' && !y.ignoreCase
              ? b
              : b.length === 2 &&
                b[0] === '\\' &&
                !h.contains(
          ...
          return (
            o === F.Lexer.NA ||
              (h.isString(o)
                ...
                : h.isRegExp(o) && no(o) && n.push({ str: o.source, idx: a, tokenType: i })),
            n
          );
        },
        []
      ...
      e &&
        h.forEach(o, function (c) {
          ...
          if (f !== !1) {
            ...
            h.has(c, 'LINE_BREAKS')
              ? c.LINE_BREAKS === !0 && (i = !0)
              : Ye.canMatchCharCode(s, c.PATTERN) && (i = !0);
        }),
      e &&
        !i &&
        n.push({
  ...
  T.LineTerminatorOptimizedTester = {
    test: function (t) {
      for (var e = t.length, r = this.lastIndex; r < e; r++) {
        ...
        if (n === 13)
          return (
            t.charCodeAt(r + 1) === 10 ? (this.lastIndex = r + 2) : (this.lastIndex = r + 1), !0
          );
      }
      return !1;
    },
...
var Xe = R((N) => {
  ...
  function Cn(t) {
    V.forEach(t, function (e) {
      bn(e) ||
        ((N.tokenIdxToClass[N.tokenShortNameIdx] = e), (e.tokenTypeIdx = N.tokenShortNameIdx++)),
...
a boolean 2nd argument is no longer supported`);
	...
	For details See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#MISSING_LINE_TERM_CHARS`);
            ...
            n.config.skipValidations === !1 &&
              (n.TRACE_INIT('performRuntimeChecks', function () {
                n.lexerDefinitionErrors = n.lexerDefinitionErrors.concat(
                  Ee.performRuntimeChecks(a, n.trackStartLines, n.config.lineTerminatorCharacters)
                );
              }),
          ...
          if (
              ...
              n.TRACE_INIT('Mode: <' + l + '> processing', function () {
                if (
                  ...
                  n.TRACE_INIT('analyzeTokenTypes', function () {
                    ...
                    (n.charCodeToPatternIdxToConfig[l] = m.charCodeToPatternIdxToConfig),
            ...
            !w.isEmpty(n.lexerDefinitionErrors) && !n.config.deferDefinitionErrorsHandling)
          ) {
          ...
          w.forEach(n.lexerDefinitionWarning, function (p) {
            ...
            n.TRACE_INIT('Choosing sub-methods implementations', function () {
              if (
                ...
                n.trackEndLines === !1 && (n.updateTokenEndLineColumnLocation = w.NOOP),
                ...
                throw Error(
                  'Invalid <positionTracking> config option: "' + n.config.positionTracking + '"'
                );
              n.hasCustom
...
` + i
          ...
          for (i = 0; i < Da; i++) {
            ...
            if (
              (ut !== !1
                ...
                : me.isCustom === !0
                ? ((g = De.exec(y, L, Z, xe)),
                  g !== null ? ((c = g[0]), g.payload !== void 0 && (f = g.payload)) : (c = null))
          ...
          if (c !== null) {
            if (
              ...
              var kt = 0,
                ...
                dr = void 0;
              at.lastIndex = 0;
              do (hr = at.test(c)), hr === !0 && ((dr = at.lastIndex - 1), kt++);
              while (hr === !0);
              kt !== 0 &&
                ((Q = Q + kt),
                (te = l - dr),
            ...
            (d = L - vr),
              (_ = this.config.errorMessageProvider.buildUnexpectedCharactersMessage(
                y,
                vr,
                d,
                an,
              ...
              ue.push({ offset: vr, line: an, column: on, length: d, message: _ });
          }
        }
      ...
      (t.prototype.updateTokenEndLineColumnLocation = function (e, r, n, i, a, o, s) {
        ...
        r !== void 0 &&
          ((c = n === s - 1),
          (f = c ? -1 : 0),
          (i === 1 && c === !0) || ((e.endLine = a + f), (e.endColumn = o - 1 + -f)));
      }),
...
var ne = R((S) => {
  ...
  function ht(t) {
    ...
    if (t instanceof Hn) return { type: 'NonTerminal', name: t.nonTerminalName, idx: t.idx };
    if (t instanceof Xn) return { type: 'Alternative', definition: e(t.definition) };
    if (t instanceof $n) return { type: 'Option', idx: t.idx, definition: e(t.definition) };
    if (t instanceof Zn)
    ...
    if (t instanceof Jn) return { type: 'Repetition', idx: t.idx, definition: e(t.definition) };
    if (t instanceof ti) return { type: 'Alternation', idx: t.idx, definition: e(t.definition) };
    if (t instanceof Dt) {
      var r = {
          type: 'Terminal',
...
var Gt = R((Ut) => {
        ...
        (t.prototype.walk = function (e, r) {
          ...
          r === void 0 && (r = []),
            Sr.forEach(e.definition, function (i, a) {
              ...
              else if (i instanceof ie.RepetitionMandatory) n.walkAtLeastOne(i, o, r);
              else if (i instanceof ie.RepetitionMandatoryWithSeparator)
                n.walkAtLeastOneSep(i, o, r);
              else if (i instanceof ie.RepetitionWithSeparator) n.walkManySep(i, o, r);
  ...
  function ri(t, e, r) {
    var n = [
        new ie.Option({
          definition: [new ie.Terminal({ terminalType: t.separator })].concat(t.definition)
        })
      ],
      i = n.concat(e, r);
    return i;
...
var vt = R((X) => {
  ...
  function xr(t, e) {
    e === void 0 && (e = []);
    var r =
      t instanceof W.Option || t instanceof W.Repetition || t instanceof W.RepetitionWithSeparator;
    return r
      ? !0
      ...
      return (
        (e.prototype.startWalking = function () {
          ...
          return (
            ...
            (this.occurrenceStack = I.cloneArr(this.path.occurrenceStack).reverse()),
            this.ruleStack.pop(),
    ...
    for (; r.length < e && i < t.length; ) {
      ...
      if (s instanceof O.Option) n = o(s.definition);
        ...
        var c = [
          ...
          new O.Repetition({
            definition: [new O.Terminal({ terminalType: s.separator })].concat(s.definition)
          })
        ];
        return o(c);
      ...
      if (!I.isEmpty(v)) {
        ...
        if (_ === i) {
          ...
          var te = new O.Terminal({ terminalType: _.separator }),
            ue = new O.Repetition({ definition: [te].concat(_.definition), idx: _.idx }),
            Q = _.definition.concat([ue], I.drop(v)),
            g = { idx: u, def: Q, ruleStack: d, occurrenceStack: A };
          l.push(g);
          ...
          l.push(fe), l.push(o);
          var te = new O.Terminal({ terminalType: _.separator }),
            xe = new O.Repetition({ definition: [te].concat(_.definition), idx: _.idx }),
  ...
  var os = (function (t) {
    ...
    Oi = (function (t) {
      ...
      function e(r, n, i) {
        var a = t.call(this) || this;
        return (
          (a.targetOccurrence = r), (a.targetProdType = n), (a.targetRef = i), (a.result = []), a
        );
      }
      return (
        ...
        function (a, o) {
          return (
            o.definition.length > 255 &&
              a.push({
                message: e.buildTooManyAlternativesError({ topLevelRule: t, alternation: o }),
...
var Ui = R((Je) => {
  ...
  function Ts(t) {
    return (
      (t = Vr.defaults(t, { errMsgProvider: Di.defaultGrammarValidatorErrorProvider })),
...
var zr = R(($) => {
  ...
  var Ps = (function () {
    ...
    return (
      ...
      (t.prototype.canPerformInRuleRecovery = function (e, r) {
        return (
          this.canRecoverWithSingleTokenInsertion(e, r) || this.canRecoverWithSingleTokenDeletion(e)
        );
      }),
      ...
      (t.prototype.getCurrentGrammarPath = function (e, r) {
        var n = this.getHumanReadableRuleStack(),
          ...
          a = { ruleStack: n, occurrenceStack: i, lastTok: e, lastTokOccurrence: r };
        return a;
      }),
  ...
  function Vi(t, e, r, n, i, a, o) {
    ...
    var m = c.token,
      v = c.occurrence,
      u = c.isEndOfRule;
    this.RULE_STACK.length === 1 && u && m === void 0 && ((m = Ht.EOF), (v = 1)),
      this.shouldInRepetitionRecoveryBeTried(m, v, o) && this.tryInRepetitionRecovery(t, e, r, m);
  }
      ...
      return (
        (t.prototype.initLooksAhead = function (e) {
          (this.dynamicTokensEnabled = ge.has(e, 'dynamicTokensEnabled')
            ...
            (this.lookAheadFuncsCache = ge.isES2015MapSupported() ? new Map() : []),
...
var Hr = R((Be) => {
  ...
  function Ds(t, e) {
    ...
    return Fs.isUndefined(r) || r.configurable
      ? (Object.defineProperty(t, Xi, { enumerable: !1, configurable: !0, writable: !1, value: e }),
        !0)
      : !1;
  }
    ...
    Ys = (function () {
      ...
      return (
        ...
        (t.prototype.RULE = function (e, r, n) {
          if (
            (n === void 0 && (n = Xr.DEFAULT_RULE_CONFIG), aa.contains(this.definedRulesNames, e))
          ) {
        ...
        (t.prototype.OVERRIDE_RULE = function (e, r, n) {
          ...
          var i = [];
          (i = i.concat(zs.validateRuleIsOverridden(e, this.definedRulesNames, this.className))),
...
Make sure that all grammar rule definitions are done before 'performSelfAnalysis' is called.`
          ...
          var c = function (p, l) {
              return (
                p === void 0 && (p = 0), this.ruleInvocationStateUpdate(o, e, p), s.call(this, l)
              );
            },
            f = 'ruleName';
        ...
        (t.prototype.atLeastOneInternalLogic = function (e, r, n) {
          ...
          if (a.call(this) === !0)
            for (var f = this.doSingleRepetition(o); a.call(this) === !0 && f === !0; )
        ...
        (t.prototype.manyInternalLogic = function (e, r, n) {
          ...
          for (var f = !0; a.call(this) === !0 && f === !0; ) f = this.doSingleRepetition(o);
          this.attemptInRepetitionRecovery(
            this.manyInternal,
            [e, r],
            a,
        ...
        (t.prototype.raiseEarlyExitException = function (e, r, n) {
          for (
            var i = this.getCurrRuleFullName(),
              ...
              o = fa.getLookaheadPathsForOptionalProd(e, a, r, this.maxLookahead),
              s = o[0],
              c = [],
              f = 1;
            f <= this.maxLookahead;
...
var Ra = R((nr) => {
  ...
  var oe = k(),
    ...
    ru = ce(),
    nu = Yt(),
    ir = { description: 'This Object indicates the Parser is during Recording Phase' };
  Object.freeze(ir);
  var Ta = !0,
    ya = Math.pow(2, nu.BITS_FOR_OCCURRENCE_IDX) - 1,
    _a = Ea.createToken({ name: 'RECORDING_PHASE_TOKEN', pattern: tu.Lexer.NA });
 ...
 inside top level rule: <` +
          ...
          var a = oe.peek(this.recordingProdStack),
            o = e.ruleName,
            s = new Pe.NonTerminal({ idx: r, nonTerminalName: o, referencedRule: void 0 });
...
var ce = R((U) => {
  ...
  U.DEFAULT_RULE_CONFIG = Object.freeze({ recoveryValueFunc: function () {}, resyncEnabled: !0 });
  var Au;
  (function (t) {
        ...
        this.TRACE_INIT('performSelfAnalysis', function () {
          ...
          if (
            (e.TRACE_INIT('Grammar Resolving', function () {
              (i = xa.resolveGrammar({ rules: ee.values(e.gastProductionsCache) })),
...
var La = R((cr) => {
  ...
  function Iu(t, e) {
    var r = e === void 0 ? {} : e,
      ...
      a = r.css,
      o =
        a === void 0 ? 'https://unpkg.com/chevrotain@' + Ca.VERSION + '/diagrams/diagrams.css' : a,
      s = `
