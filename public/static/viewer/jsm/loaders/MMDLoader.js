  ...
  build(data, geometry /*, onProgress, onError */) {
    ...
    for (let i = 0; i < data.metadata.materialCount; i++) {
      ...
      if (data.metadata.format === 'pmd') {
        ...
        const toonFileName =
          material.toonIndex === -1 ? 'toon00.bmp' : data.toonTextures[material.toonIndex].fileName;
...
class AnimationBuilder {
  ...
  buildCameraAnimation(vmd) {
    ...
    tracks.push(
      this._createTrack('.quaternion', QuaternionKeyframeTrack, times, quaternions, qInterpolations)
    );
    tracks.push(
