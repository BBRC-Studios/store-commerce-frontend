    ...
    const processInfoSubobjects = async (info, subobject = null) => {
      ...
      for (let i = 0, l = subobjectInfos.length; i < l; i++) {
        ...
        for (let i = 0, l = lineSegments.length; i < l; i++) {
          ...
          ls.material =
            ls.material || getMaterialFromCode(ls.colorCode, ls.colorCode, info.materials, true);
        ...
        for (let i = 0, l = conditionalSegments.length; i < l; i++) {
          ...
          os.material =
            os.material || getMaterialFromCode(os.colorCode, os.colorCode, info.materials, true);
        ...
        for (let i = 0, l = faces.length; i < l; i++) {
          ...
          tri.material =
            tri.material || getMaterialFromCode(tri.colorCode, colorCode, info.materials, false);
  ...
  getMaterial(colorCode) {
    if (colorCode.startsWith('0x2')) {
      ...
      return this.parseColorMetaDirective(
        new LineParser(
          'Direct_Color_' + color + ' CODE -1 VALUE #' + color + ' EDGE #' + color + ''
        )
      );
    }
