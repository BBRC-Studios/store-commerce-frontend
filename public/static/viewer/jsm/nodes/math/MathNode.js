    ...
    if (method === MathNode.TRANSFORM_DIRECTION) {
      ...
      if (method === MathNode.CROSS) {
        ...
        params.push(
          a.build(
            builder,
            builder.getTypeLength(a.getNodeType(builder)) === 1 ? 'float' : inputType
          ),
        ...
        params.push(
          ...
          b.build(
            builder,
            builder.getTypeLength(b.getNodeType(builder)) === 1 ? 'float' : inputType
          )
        );
        ...
        params.push(
          ...
          c.build(
            builder,
            builder.getTypeLength(c.getNodeType(builder)) === 1 ? 'float' : inputType
          )
        );
      } else {
